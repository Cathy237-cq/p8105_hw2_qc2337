...
After I import “results.csv”, I realize that the column names need to
change, then I went back to the original “results.csv” when it first
import. I found out the first 2 rows is not organized in a way R can
read, so I skip the first 2 rows.
...
```
    ...
    ## # A tibble: 0 × 3
    ## # ℹ 3 variables: series <dbl>, episode <chr>, star_baker_or_winner <chr>
